...
\begin{optionlist}
   \item[layout] Set the \textpkgname{KOMA-script} page layout according to one of the following options:
   \begin{valuelist}
   ...
   \item[raggedlists] Set lists (itemize, enumerate, description) \dots
   \begin{valuelist}
...
\begin{optionlist}
   \item[dottedtoc] Set page numbers in the table of contents \dots
   \begin{valuelist}
      \item[=\optionvaluedefaultfont{true}] \dots flushed right. For sections entries and below, page numbers are separated by dots. For part and chapter entries, empty space is used by default. This default be changed with the options \optionfont{dottedtocparts} and \optionfont{dottedtocchapters}.
      \item[=false] \dots separated by a fixed-width space.
   \end{valuelist}
   
   \item[dottedtocparts] Separate part entries and page numbers in the table of contents \dots
   \begin{valuelist}
      \item[=\optionvaluedefaultfont{false}] \dots with empty space.
      \item[=true] \dots with dots. This value should only be used with \optionfont{dottedtoc}\optionvaluefont{=true}.
   \end{valuelist}
   
   \item[dottedtocchapters] Separate chapter entries and page numbers in the table of contents \dots
   \begin{valuelist}
      \item[=\optionvaluedefaultfont{false}] \dots with empty space.
      \item[=true] \dots with dots. This value should only be used with \optionfont{dottedtoc}\optionvaluefont{=true}.
   \end{valuelist}
   
   \item[tocpartentriesbold] Format part entries in the table of contents \dots
   \begin{valuelist}
   ...
   \item[tocchapterentriesbold] Format chapter entries in the table of contents \dots
   \begin{valuelist}
      \item[=\optionvaluedefaultfont{true}] \dots with bold font.
      \item[=false] \dots with spaced low small caps. (This is the default setting of \textpkgname{ClassicThesis}). 
   \end{valuelist}
   
   \item[tocentriesbold] Format part and chapter entries in the table of contents \dots
   \begin{valuelist}
      \item[=\optionvaluedefaultfont{true}] \dots with bold font.
      \item[=false] \dots with spaced low small caps. (This is the default setting of \textpkgname{ClassicThesis}). 
   \end{valuelist}
